...
;(function(window) {
	...
	var support = {transitions : Modernizr.csstransitions},
		...
		// listjs initiliazation (all mall麓s spaces)
	...
	function initEvents() {
		...
		// click on the show mall麓s levels ctrl
	...
	/**
	 * Navigate through the mall麓s levels
	 */
	function navigate(direction) {
		...
		// hide the previous level麓s pins
